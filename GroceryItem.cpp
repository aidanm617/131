...
namespace    // unnamed, anonymous namespace
{
    ...
    template< typename T, typename U >   requires std::is_floating_point_v<std::common_type_t<T, U> >
        constexpr bool floating_point_is_equal(T const lhs, U const rhs, double const EPSILON = 1e-4) noexcept
        {
            ...
            return (std::abs(lhs - rhs) <= (std::max(std::abs(lhs), std::abs(rhs)) * EPSILON));
...
{
    ///////////////////////// TO-DO (13) //////////////////////////////
    _brandName = std::move(_brandName);
    return _brandName;
    /////////////////////// END-TO-DO (13) ////////////////////////////
}
...
{
    ///////////////////////// TO-DO (14) //////////////////////////////
    _productName = std::move(_productName);
    return _productName;
    /////////////////////// END-TO-DO (14) ////////////////////////////
}
...
GroceryItem& GroceryItem::upcCode(std::string newUpcCode)&
{
    ...
    return upcCode(std::move(newUpcCode));
    /////////////////////// END-TO-DO (15) ////////////////////////////
}
...
GroceryItem& GroceryItem::brandName(std::string newBrandName)&
{
    ...
    return brandName(std::move(newBrandName));
    /////////////////////// END-TO-DO (16) ////////////////////////////
}
...
GroceryItem& GroceryItem::productName(std::string newProductName)&
{
    ...
    return productName(std::move(newProductName));
    /////////////////////// END-TO-DO (17) ////////////////////////////
}
...
GroceryItem& GroceryItem::price(double newPrice)&
{
    ...
    return price(std::move(newPrice));
    /////////////////////// END-TO-DO (18) ////////////////////////////
}
...
std::weak_ordering GroceryItem::operator<=>(const GroceryItem& rhs) const noexcept
{
    ...
    ///////////////////////// TO-DO (19) //////////////////////////////
    return GroceryItem::operator<=>(rhs._upcCode);
    return GroceryItem::operator<=>(rhs._productName);
    return GroceryItem::operator<=>(rhs._brandName);
    return GroceryItem::operator<=>(std::to_string(rhs._price));
    /////////////////////// END-TO-DO (19) ////////////////////////////
}
